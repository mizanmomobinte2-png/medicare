...
// =====================================
// GET TODAY'S APPOINTMENTS OF DOCTOR
// =====================================
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "Doctor appointment summary error:",
        err
      );
...
// =====================================
// GET UNIQUE PATIENTS OF ONE DOCTOR
// =====================================
...
router.patch(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.error(
        "Doctor update appointment error:",
        err
      );
...
// =====================================
// STAFF ASSIGN / SCHEDULE APPOINTMENT
// =====================================
    ...
    try {
      ...
      if (result.rows.length === 0) {
        return res.status(409).json({
          error:
            "Appointment is assigned to another staff or appointment does not exist",
        });
      }
      ...
      console.error(
        "Staff appointment update error:",
        err
      );
